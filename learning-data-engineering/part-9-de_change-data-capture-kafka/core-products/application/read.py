...
class ReadData:
    ...
    def insert(self):
        ...
        consumer = KafkaConsumer(
                        "dbserver1345.inventory.products",
        ...
        for message in consumer:
            ...
            dx = df[["schema.name","payload.before.id","payload.before.name","payload.before.description","payload.before.weight",
            "payload.after.id","payload.after.name","payload.after.description","payload.after.weight"
            ]]
            ...
            try:
                ...
                dx.to_sql('sample_products', engine, if_exists = 'replace', index = False)
