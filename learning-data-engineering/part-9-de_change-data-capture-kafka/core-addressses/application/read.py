...
class ReadData:
    ...
    def insert(self):
        ...
        consumer = KafkaConsumer(
                        "dbserver1345.inventory.addresses",
        ...
        for message in consumer:
            ...
            dx = df[["schema.name","payload.before.id","payload.before.customer_id","payload.before.street","payload.before.city", "payload.before.state",
            "payload.before.zip", "payload.before.city", 
            "payload.after.id","payload.after.customer_id","payload.after.street","payload.after.city", "payload.after.state",
            "payload.after.zip", "payload.after.city"
            ]]
            ...
            try:
                ...
                dx.to_sql('sample_addresses', engine, if_exists = 'replace', index = False)
